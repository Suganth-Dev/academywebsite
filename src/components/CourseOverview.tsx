      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            From DGCA certification to specialized skills, choose from our comprehensive range of drone training programs designed for different career paths and expertise levels.
          </p>
        </div>
        ...
        <div className="text-center mt-16">
          ...
          <button
            ...
            className="inline-flex items-center bg-[#26A65B] text-white font-bold px-8 py-4 rounded-lg hover:bg-[#228B50] hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-200 text-lg"
          >
